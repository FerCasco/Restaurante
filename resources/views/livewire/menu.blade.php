<div class="flex m-auto justify-center">
    ...
    <div class="z-10 fixed my-4 flex bg-gray-100 hover:bg-gray-200 shadow-xl rounded-lg transition-all duration-1000 p-1 dark:bg-gray-700 dark:hover:bg-gray-600">
        <nav class="flex space-x-2">
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/inicio">
                <ion-icon name="home" class="-translate-y-20 transition-all group-hover:translate-y-0 text-2xl"></ion-icon>
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.salas')}}</p>
            </a>
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/cocina">
                ...
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.cocina')}}</p>
            ...
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/inventario">
                ...
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.inventario')}}</p>
            ...
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/contactos">
                ...
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.contactos')}}</p>
            </a>
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/graficas">
                ...
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.graficos')}}</p>
            </a>
            <a class="group py-3 px-4 inline-flex flex-col items-center gap-2 hover:bg-white hover:scale-105 transition-all text-sm text-gray-700 font-medium rounded-md shadow-lg dark:bg-gray-800 dark:text-gray-400 w-32 justify-center" href="/datosAlmacenados">
                ...
                <p class="-translate-y-3 group-hover:translate-y-0">{{__('welcome.diario')}}</p>
            </a>
        </nav>
    </div>
</div>
