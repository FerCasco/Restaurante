            ...
            <div class="mx-8 p-8 bg-gray-100 rounded">
                <div class="flex justify-end mb-1.5">
                    <button wire:click="verModal('proveedores')"
                            class="block text-white bg-orange-400 hover:bg-orange-300 focus:ring-4 focus:outline-none focus:ring-orange-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-300 dark:hover:bg-orange-400 dark:focus:ring-orange-500"
            ...
            <div class="mx-8 p-8 bg-gray-100 rounded">
                <div class="flex justify-end mb-1.5">
                    <button wire:click="verModal('trabajadores')"
                            class="block text-white bg-pink-400 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    ...
                    <div class="relative bg-white w-2/5 rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-6" wire:ignore>
                                ...
                                <button type="submit" wire:click="addTrabajador()"
                                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Alta
                                </button>
                            </form>
