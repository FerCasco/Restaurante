...
<div class="absolute bg-cover h-full w-full">
    <!--<div class="absolute h-full w-full bg-white opacity-25">
        ...
        <form wire:submit.prevent="reservar" class="rounded-full bg-white mt-36 mx-auto w-3/5 rounded-lg shadow-lg flex flex-col flex-wrap  p-8 ">
            ...
            <textarea class="mb-8 h-40 rounded-lg border border-gray-200 bg-gray-200 w-10/12 mx-auto" wire:model="miReserva.anotaciones" id="anotaciones" name="anotaciones"></textarea>
