...
<div class="grid grid-cols-3 gap-4 ml-72 mt-12 pl-28">
    @foreach($familias as $familia)
        <a class="hover:shadow-inner cursor-pointer shadow-xlblock max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
