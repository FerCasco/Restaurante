<div>
    ...
    <div class="bg-white-400 h-screen overflow-hidden flex items-center justify-center">
        <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl border-2 rounded-2xl">
            ...
            <form class="p-12 md:p-24">
                <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    <input type="text" wire:model="email" placeholder="{{__('auth.email')}}" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full">
                    @error('email') <span class="text-danger error">{{ $message }}</span>@enderror
                </div>
                ...
                <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    <input type="password" wire:model="password" placeholder="{{__('auth.contraseña')}}" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full">
                    @error('password') <span class="text-danger error">{{ $message }}</span>@enderror
                </div>
