<div class="text-gray-200 m-auto">
    <div class="flex justify-center items-center w-full m-auto">
        ...
        <form wire:submit.prevent="newMercancia" class="grid grid-cols-2 gap-16 items-center h-full w-full rounded-lg w-3/4 ml-80 p-4 mt-32 mr-48">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="cantidad" class="mb-2 text-sm font-medium dark:text-white">Cantidad:</label>
            ...
            <button type="submit" wire:click='' class=" flex justify-center items-center text-white bg-blue-700 h-2/3 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon mr-2 icon-tabler icon-tabler-square-rounded-plus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
