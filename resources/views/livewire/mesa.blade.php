<center>
    @php
        ...
        $colorsHover = ['bg-red-500', 'bg-blue-500', 'bg-green-500'];
        $color = 'bg-yellow-300';
    ...
    <div class="grid grid-cols-4 gap-4 ml-72 mt-40 pl-28">
        @forelse($mesas as $mesa)
            ...
            @endphp
            <button
                class="h-48 w-48 text-white hover:{{$colorHover}} transition-all shadow-inner from-green-400 {{$color}} focus:ring-4 focus:outline-none font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 mb-2"
