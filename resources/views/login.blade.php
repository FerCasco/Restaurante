...
{{--                </svg>--}}
            ...
            <form class="p-12 md:p-24">
                ...
                <button class="bg-indigo-400 hover:bg-indigo-600 border border-indigo-700 shadow-lg hover:shadow-inner font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
            </form>
        </div>
    </div>
</body>
